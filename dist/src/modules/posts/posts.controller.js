...
let PostsController = class PostsController {
    ...
    findAllManage(page, limit, search, userId, category, status) {
    ...
    getReactionsManage(postId, page, limit, type) {
    ...
    getReactionsSummary(postId) {
        return this.postsService.getReactionsSummary(postId);
    }
    getCommentsManage(postId, page, limit, status) {
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)(user_role_enum_1.Permission.POSTS_MANAGE),
    __param(0, (0, common_1.Query)('page')),
    __param(1, (0, common_1.Query)('limit')),
    ...
    __metadata("design:returntype", void 0)
], PostsController.prototype, "findAllManage", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PostsController.prototype, "setStatus", null);
__decorate([
    (0, common_1.Get)(':id/reactions/manage'),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.SYSTEM_ADMIN, user_role_enum_1.UserRole.ACADEMIC_MANAGER),
    (0, permissions_decorator_1.RequirePermissions)(user_role_enum_1.Permission.POSTS_MANAGE),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Query)('page')),
    ...
    __metadata("design:returntype", void 0)
], PostsController.prototype, "getReactionsManage", null);
__decorate([
    (0, common_1.Get)(':id/reactions/summary'),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.SYSTEM_ADMIN, user_role_enum_1.UserRole.ACADEMIC_MANAGER),
    (0, permissions_decorator_1.RequirePermissions)(user_role_enum_1.Permission.POSTS_MANAGE),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], PostsController.prototype, "getReactionsSummary", null);
__decorate([
    (0, common_1.Get)(':id/comments/manage'),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.SYSTEM_ADMIN, user_role_enum_1.UserRole.ACADEMIC_MANAGER),
    (0, permissions_decorator_1.RequirePermissions)(user_role_enum_1.Permission.POSTS_MANAGE),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Query)('page')),
    ...
    __metadata("design:paramtypes", [Number, String, String, String]),
    __metadata("design:returntype", void 0)
], PostsController.prototype, "getCommentsManage", null);
__decorate([
    (0, common_1.Post)('comments/:commentId/status'),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.SYSTEM_ADMIN, user_role_enum_1.UserRole.ACADEMIC_MANAGER),
    (0, permissions_decorator_1.RequirePermissions)(user_role_enum_1.Permission.POSTS_MANAGE),
    ...
    __metadata("design:paramtypes", [Number, String]),
    __metadata("design:returntype", void 0)
], PostsController.prototype, "setCommentStatus", null);
