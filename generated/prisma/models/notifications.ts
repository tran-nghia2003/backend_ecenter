...
export interface notificationsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const notificationsWithNoti_idOnly = await prisma.notifications.findMany({ select: { noti_id: true } })
   * 
   */
   ...
   * const notificationsWithNoti_idOnly = await prisma.notifications.createManyAndReturn({
   *   select: { noti_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Notifications and only return the `noti_id`
   * const notificationsWithNoti_idOnly = await prisma.notifications.updateManyAndReturn({
   *   select: { noti_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
