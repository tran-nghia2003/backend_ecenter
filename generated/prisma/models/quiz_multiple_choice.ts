...
export interface quiz_multiple_choiceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `mcq_id`
   * const quiz_multiple_choiceWithMcq_idOnly = await prisma.quiz_multiple_choice.findMany({ select: { mcq_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Quiz_multiple_choices and only return the `mcq_id`
   * const quiz_multiple_choiceWithMcq_idOnly = await prisma.quiz_multiple_choice.createManyAndReturn({
   *   select: { mcq_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Quiz_multiple_choices and only return the `mcq_id`
   * const quiz_multiple_choiceWithMcq_idOnly = await prisma.quiz_multiple_choice.updateManyAndReturn({
   *   select: { mcq_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
/**
 * quiz_multiple_choice.quiz_base
 */
