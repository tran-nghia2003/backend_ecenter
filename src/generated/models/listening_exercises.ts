...
// @ts-nocheck 
/*
 * This file exports the `listening_exercises` model and its related types.
 *
...
export type Listening_exercisesAggregateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which listening_exercises to aggregate.
   */
  where?: Prisma.listening_exercisesWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   * 
   * Determine the order of listening_exercises to fetch.
   */
   ...
   * 
   * Take `±n` listening_exercises from the position of the cursor.
   */
  take?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
   * 
   * Skip the first `n` listening_exercises.
   */
  skip?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
   * 
   * Count returned listening_exercises
  **/
...
export type GetListening_exercisesAggregateType<T extends Listening_exercisesAggregateArgs> = {
      [P in keyof T & keyof AggregateListening_exercises]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateListening_exercises[P]>
    : Prisma.GetScalarType<T[P], AggregateListening_exercises[P]>
}
...
type GetListening_exercisesGroupByPayload<T extends listening_exercisesGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Listening_exercisesGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Listening_exercisesGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Listening_exercisesGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Listening_exercisesGroupByOutputType[P]>
      }
    >
  >
...
/**
 * Count Type Listening_exercisesCountOutputType
 */
...
/**
 * Listening_exercisesCountOutputType without action
 */
export type Listening_exercisesCountOutputTypeDefaultArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Select specific fields to fetch from the Listening_exercisesCountOutputType
   */
...
export type listening_exercisesCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<listening_exercisesFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface listening_exercisesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['listening_exercises'], meta: { name: 'listening_exercises' } }
  /**
   * Find zero or one Listening_exercises that matches the filter.
   * @param {listening_exercisesFindUniqueArgs} args - Arguments to find a Listening_exercises
   * @example
   * // Get one Listening_exercises
   * const listening_exercises = await prisma.listening_exercises.findUnique({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find one Listening_exercises that matches the filter or throw an error with `error.code='P2025'`
   * if no matches were found.
   * @param {listening_exercisesFindUniqueOrThrowArgs} args - Arguments to find a Listening_exercises
   * @example
   * // Get one Listening_exercises
   * const listening_exercises = await prisma.listening_exercises.findUniqueOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first Listening_exercises that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {listening_exercisesFindFirstArgs} args - Arguments to find a Listening_exercises
   * @example
   * // Get one Listening_exercises
   * const listening_exercises = await prisma.listening_exercises.findFirst({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first Listening_exercises that matches the filter or
   * throw `PrismaKnownClientError` with `P2025` code if no matches were found.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {listening_exercisesFindFirstOrThrowArgs} args - Arguments to find a Listening_exercises
   * @example
   * // Get one Listening_exercises
   * const listening_exercises = await prisma.listening_exercises.findFirstOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find zero or more Listening_exercises that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {listening_exercisesFindManyArgs} args - Arguments to filter and select certain fields only.
   * @example
   * // Get all Listening_exercises
   * const listening_exercises = await prisma.listening_exercises.findMany()
   * 
   * // Get first 10 Listening_exercises
   * const listening_exercises = await prisma.listening_exercises.findMany({ take: 10 })
   * 
   * // Only select the `exercise_id`
   * const listening_exercisesWithExercise_idOnly = await prisma.listening_exercises.findMany({ select: { exercise_id: true } })
   * 
   */
  ...
  /**
   * Create a Listening_exercises.
   * @param {listening_exercisesCreateArgs} args - Arguments to create a Listening_exercises.
   * @example
   * // Create one Listening_exercises
   * const Listening_exercises = await prisma.listening_exercises.create({
   *   data: {
   *     // ... data to create a Listening_exercises
   *   }
   * })
   * 
   */
  ...
  /**
   * Create many Listening_exercises.
   * @param {listening_exercisesCreateManyArgs} args - Arguments to create many Listening_exercises.
   * @example
   * // Create many Listening_exercises
   * const listening_exercises = await prisma.listening_exercises.createMany({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
  ...
  /**
   * Create many Listening_exercises and returns the data saved in the database.
   * @param {listening_exercisesCreateManyAndReturnArgs} args - Arguments to create many Listening_exercises.
   * @example
   * // Create many Listening_exercises
   * const listening_exercises = await prisma.listening_exercises.createManyAndReturn({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   * 
   * // Create many Listening_exercises and only return the `exercise_id`
   * const listening_exercisesWithExercise_idOnly = await prisma.listening_exercises.createManyAndReturn({
  ...
  /**
   * Delete a Listening_exercises.
   * @param {listening_exercisesDeleteArgs} args - Arguments to delete one Listening_exercises.
   * @example
   * // Delete one Listening_exercises
   * const Listening_exercises = await prisma.listening_exercises.delete({
   *   where: {
   *     // ... filter to delete one Listening_exercises
   *   }
   * })
   * 
   */
  ...
  /**
   * Update one Listening_exercises.
   * @param {listening_exercisesUpdateArgs} args - Arguments to update one Listening_exercises.
   * @example
   * // Update one Listening_exercises
   * const listening_exercises = await prisma.listening_exercises.update({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Delete zero or more Listening_exercises.
   * @param {listening_exercisesDeleteManyArgs} args - Arguments to filter Listening_exercises to delete.
   * @example
   * // Delete a few Listening_exercises
   * const { count } = await prisma.listening_exercises.deleteMany({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Update zero or more Listening_exercises.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {listening_exercisesUpdateManyArgs} args - Arguments to update one or more rows.
   * @example
   * // Update many Listening_exercises
   * const listening_exercises = await prisma.listening_exercises.updateMany({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Update zero or more Listening_exercises and returns the data updated in the database.
   * @param {listening_exercisesUpdateManyAndReturnArgs} args - Arguments to update many Listening_exercises.
   * @example
   * // Update many Listening_exercises
   * const listening_exercises = await prisma.listening_exercises.updateManyAndReturn({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: [
   ...
   * })
   * 
   * // Update zero or more Listening_exercises and only return the `exercise_id`
   * const listening_exercisesWithExercise_idOnly = await prisma.listening_exercises.updateManyAndReturn({
   *   select: { exercise_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
  ...
  /**
   * Create or update one Listening_exercises.
   * @param {listening_exercisesUpsertArgs} args - Arguments to update or create a Listening_exercises.
   * @example
   * // Update or create a Listening_exercises
   * const listening_exercises = await prisma.listening_exercises.upsert({
   *   create: {
   *     // ... data to create a Listening_exercises
   *   },
   *   update: {
   ...
   *   },
   *   where: {
   *     // ... the filter for the Listening_exercises we want to update
   *   }
   * })
   */
  ...
  /**
   * Count the number of Listening_exercises.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {listening_exercisesCountArgs} args - Arguments to filter Listening_exercises to count.
   * @example
   * // Count the number of Listening_exercises
   * const count = await prisma.listening_exercises.count({
   *   where: {
   *     // ... the filter for the Listening_exercises we want to count
   *   }
   * })
  **/
  count<T extends listening_exercisesCountArgs>(
    args?: Prisma.Subset<T, listening_exercisesCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Listening_exercisesCountAggregateOutputType>
      : number
  >

  /**
   * Allows you to perform aggregations operations on a Listening_exercises.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {Listening_exercisesAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
   * @example
  ...
  **/
  ...
  /**
   * Group by Listening_exercises.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {listening_exercisesGroupByArgs} args - Group by arguments.
   * @example
  ...
  **/
  groupBy<
    T extends listening_exercisesGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, listening_exercisesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetListening_exercisesGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
 * Fields of the listening_exercises model
 */
readonly fields: listening_exercisesFieldRefs;
}

/**
 * The delegate class that acts as a "Promise-like" for listening_exercises.
...
// Custom InputTypes
/**
 * listening_exercises findUnique
 */
export type listening_exercisesFindUniqueArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  /**
   * Filter, which listening_exercises to fetch.
   */
  where: Prisma.listening_exercisesWhereUniqueInput
}

/**
 * listening_exercises findUniqueOrThrow
 */
...
export type listening_exercisesFindFirstArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for searching for listening_exercises.
   */
  cursor?: Prisma.listening_exercisesWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type listening_exercisesFindManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for listing listening_exercises.
   */
  cursor?: Prisma.listening_exercisesWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type listening_exercisesCreateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to create many listening_exercises.
   */
...
/**
 * listening_exercises createManyAndReturn
 */
...
export type listening_exercisesUpdateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.listening_exercisesInclude<ExtArgs> | null
  /**
   * The data needed to update a listening_exercises.
   */
  data: Prisma.XOR<Prisma.listening_exercisesUpdateInput, Prisma.listening_exercisesUncheckedUpdateInput>
  /**
   * Choose, which listening_exercises to update.
   */
  where: Prisma.listening_exercisesWhereUniqueInput
}

/**
 * listening_exercises updateMany
 */
export type listening_exercisesUpdateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to update listening_exercises.
   */
  data: Prisma.XOR<Prisma.listening_exercisesUpdateManyMutationInput, Prisma.listening_exercisesUncheckedUpdateManyInput>
  /**
   * Filter which listening_exercises to update
   */
  where?: Prisma.listening_exercisesWhereInput
  /**
   * Limit how many listening_exercises to update.
   */
  limit?: number
}

/**
 * listening_exercises updateManyAndReturn
 */
...
export type listening_exercisesUpsertArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.listening_exercisesInclude<ExtArgs> | null
  /**
   * The filter to search for the listening_exercises to update in case it exists.
   */
  where: Prisma.listening_exercisesWhereUniqueInput
  /**
   * In case the listening_exercises found by the `where` argument doesn't exist, create a new listening_exercises with this data.
   */
  create: Prisma.XOR<Prisma.listening_exercisesCreateInput, Prisma.listening_exercisesUncheckedCreateInput>
  /**
   * In case the listening_exercises was found with the provided `where` argument, update it with this data.
   */
  update: Prisma.XOR<Prisma.listening_exercisesUpdateInput, Prisma.listening_exercisesUncheckedUpdateInput>
}

/**
 * listening_exercises delete
 */
export type listening_exercisesDeleteArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.listening_exercisesInclude<ExtArgs> | null
  /**
   * Filter which listening_exercises to delete.
   */
  where: Prisma.listening_exercisesWhereUniqueInput
}

/**
 * listening_exercises deleteMany
 */
export type listening_exercisesDeleteManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  where?: Prisma.listening_exercisesWhereInput
  /**
   * Limit how many listening_exercises to delete.
   */
  limit?: number
}

/**
 * listening_exercises.lessons
 */
...
/**
 * listening_exercises.listening_attempt_sets
 */
...
/**
 * listening_exercises without action
 */
